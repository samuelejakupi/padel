            ...
            <section className="dashboard-grid">
              <div className="dashboard-main">
                ...
                <div className="section-head">
                  ...
                  <div className="court-actions">
                    ...
                    <button className="button button-dark cta-see-all-top" aria-label="Vedi tutte le partite" onClick={() => setPadelView("matches")}>Vedi tutto</button>
                  </div>
                </div>
                {matches.length ? (
                  ...
                  <div className="fade-stack">
                    ...
                    <button className="button button-dark button-full cta-see-all-bottom" aria-label="Vedi tutte le partite" onClick={() => setPadelView("matches")}>Vedi tutto</button>
                  </div>
                ) : (
              ...
              <aside className="dashboard-side">
                ...
                <div className="fade-stack">
                  ...
                  <button className="button button-dark button-full cta-see-all-bottom" aria-label="Vedi il ranking completo" onClick={() => setPadelView("ranking")}>Vedi tutto</button>
                </div>
              </aside>
            </section>
          </>
